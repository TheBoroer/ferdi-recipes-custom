...
module.exports = Franz => {
  const getMessages = function getMessages() {
    let oldCount = document.querySelectorAll('._5fx8:not(._569x),._1ht3:not(._569x)').length;
    let count = oldCount + document.querySelectorAll('[aria-label="Mark as Read"').length;
